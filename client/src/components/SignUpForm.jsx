      ...
      >
        ...
        >
          ...
          <Typography
            component="h1"
            variant="h6"
            sx={{ fontFamily: "Agbalumo", color: "black" }}
          >
            Inscrivez-vous et débloquez la possibilité de sauvegarder vos
            recettes favorites, donner votre avis et profiter des conseils
            experts de notre chef cuisinier !
          </Typography>
        </div>
      </Grid>
